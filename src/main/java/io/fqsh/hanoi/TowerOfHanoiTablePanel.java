...
@Singleton
public class TowerOfHanoiTablePanel {
    ...
    private JScrollPane buildTable() {
        String[] columns = new String[] {
            "Liczba krążków", "Czas obliczania - iteracyjnie", "Czas obliczania - rekurencyjnie"
        };

        Object[][] rows = new Object[5][3];

        IntStream.rangeClosed(0, 4).forEach(index -> {
            rows[index][0] = hanoiSettingsPanel.getSamples().get(index);
